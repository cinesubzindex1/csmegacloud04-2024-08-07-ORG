...
app.use(async (req, res, next) => {
    ...
    try {
        ...
        if(gd.link) {
           if(btn.server1.active) links[btn.server1.z]=`<a href="${gd.link + '&server=cs_old'}" class="button direct-download" id="link1"> <img src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEgGcFYvss-Eq3dRxGITY1zT7AvNkpi6_Zr68BdoJgpYJQFICWQoLal8eznH04ziVIQt-2LCDmVuU3gUPAngwVZ_hrKvYY0o_Syk8a55IcMx_B37esgZ9AMyvBLgJEemckoyy-_skNvWaNTLsCO1wlCM2ilmcPaMKKp41EoraHmHG3QgUXsccJXSLn2pfiY/s320/download-circular-button.png" alt="Direct Download Logo"> Direct Download</a>`
           if(btn.server2.active) links[btn.server2.z]=`<a href="${btn.server2.domain + gd.link}" class="button direct-download" id="link1"> <img src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEgGcFYvss-Eq3dRxGITY1zT7AvNkpi6_Zr68BdoJgpYJQFICWQoLal8eznH04ziVIQt-2LCDmVuU3gUPAngwVZ_hrKvYY0o_Syk8a55IcMx_B37esgZ9AMyvBLgJEemckoyy-_skNvWaNTLsCO1wlCM2ilmcPaMKKp41EoraHmHG3QgUXsccJXSLn2pfiY/s320/download-circular-button.png" alt="Direct Download Logo"> Direct Download 2</a>`
