...
app.use(async (req, res, next) => {
    ...
    try {
        ...
        if(gd.link) {
           if(btn.server1.active) links[btn.server1.z]=`<a href="${gd.link + '&server=cs_old'}" class="button direct-download" id="link1"> <img src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEiLHGbOPLKtZvglaTdONYbPOWK2_cZUr_YBZ34DBxcY_fIQ4l0zllhM-X3_1cV_3IwxRmWyh5YzSYopG76n6Es3F489_GVlhyphenhyphen8LapqhZ3ETzuFLU4WCocuOC98SP7Ha01GDIOig4SlZ2ETob530N-mmtChnTA-m4e7m7Vd-W5320vukxZ0oAjXx_x1f1pM/s320/down-arrow.png" alt="Direct Download Logo"> Direct Download</a>`
           if(btn.server2.active) links[btn.server2.z]=`<a href="${btn.server2.domain + gd.link}" class="button direct-download" id="link1"> <img src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEiLHGbOPLKtZvglaTdONYbPOWK2_cZUr_YBZ34DBxcY_fIQ4l0zllhM-X3_1cV_3IwxRmWyh5YzSYopG76n6Es3F489_GVlhyphenhyphen8LapqhZ3ETzuFLU4WCocuOC98SP7Ha01GDIOig4SlZ2ETob530N-mmtChnTA-m4e7m7Vd-W5320vukxZ0oAjXx_x1f1pM/s320/down-arrow.png"> Direct Download 2</a>`
